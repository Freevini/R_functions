plotmodule <- function(networkFile=networkFile, pch_pet = pch_vector, names_size_pet = names_pch_vecor,
  ...
  cfg_pet <- cluster_edge_betweenness(as.undirected(networkFile))
